...
namespace BarberFlow.Web.Controllers
{
    ...
    public class BarbersController : Controller
    {
        ...
        public BarbersController(BarberFlowDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FirstName,LastName,Email,PhoneNumber")] Barber barber)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,PhoneNumber")] Barber barber)
        {
            if (id != barber.Id)
            {
                return NotFound();
